...
function generalSearchFunction() {
  let searchResultCard = '';
  movies.filter((item) => {
    console.log();
    if (
      item.title.toLowerCase().includes(generalSearchInput.value.toLowerCase())
    ) {
      console.log(item);
      searchResultCard += `
...
function generalSearchSystem(e) {
  //   console.log(generalSearchInput.value);
